...
// Disabled objects with these IDs or with these PROPS when they have no Wiki links
const DISABLED_UNLINKED_PRE: [&str; 150] = [
...
// Disabled objects with these IDs always, as they hold no meaning
const DISABLED_ALWAYS_PRE: [&str; 127] = [
// Meta
...
// Remove these properties / claims from each object. These are mostly external IDs.
const DISABLED_PROPS_PRE: [&str; 6723] = [
...
lazy_static! {
    pub static ref DISABLED_PROPS: HashSet<&'static str> = {
        let set = HashSet::from(DISABLED_PROPS_PRE);
        set
    };
}

lazy_static! {
    pub static ref DISABLED_ALWAYS: HashSet<&'static str> = {
        let set = HashSet::from(DISABLED_ALWAYS_PRE);
        set
    };
}

lazy_static! {
    pub static ref DISABLED_UNLINKED: HashSet<&'static str> = {
        let set = HashSet::from(DISABLED_UNLINKED_PRE);
        set
    };
}
